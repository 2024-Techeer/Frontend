...
const SubmissionPage = () => {
  ...
  useEffect(() => {
    const fetchApplicationForm = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost/api/v1/recruitments/${recruitmentId}/applications`, { headers });
  ...
  const handleCreateClick = async () => {
    try {
      ...
      // 첫 번째 API: 제출 생성
      const submissionResponse = await axios.post(`http://localhost/api/v1/applications/${application.applicationId}/submissions`, {}, { headers });
      ...
      for (const question of application.questions) {
        ...
        let url = `http://localhost/api/v1/applications/questions/${question.questionId}/submissions/${submissionId}/answers`;
